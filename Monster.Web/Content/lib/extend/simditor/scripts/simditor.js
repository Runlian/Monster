(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require("jquery"),require("simple-module"),require("simple-hotkeys"),require("simple-uploader"),require("dompurify"));
      ...
      layui.define(['jquery', 'module', 'hotkeys', 'uploader','dompurify'], function (exports) {
          exports('simditor', factory(layui.jquery, layui.module, layui.hotkeys, layui.uploader, layui.dompurify));
	  });
  }else {
